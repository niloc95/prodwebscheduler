...
class Google extends CI_Controller {
     ...
     * api console account, the "http://path-to-@WebScheduler/google/oauth_callback" should be included in an allowed redirect URL.
     */
    ...
    public function sync($provider_id = NULL)
    {
        try
        {
            ...
            foreach ($appointments as $appointment)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        // If gcal event is different from @WebScheduler appointment then update @WebScheduler record.
                        $is_different = FALSE;
                    ...
                    {
                        // Appointment not found on gcal, delete from @WebScheduler.
            ...
            // :: ADD GCAL EVENTS THAT ARE NOT PRESENT ON @WebScheduler
            ...
            foreach ($events->getItems() as $event)
            {
                ...
                if (count($results) == 0)
                {
                    // Record doesn't exist in @WebScheduler, so add the event now.
                    $appointment = [
