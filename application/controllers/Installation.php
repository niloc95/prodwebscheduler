 ...
 * This controller will handle the installation procedure of @WebScheduler
...
class Installation extends CI_Controller {
     ...
     * [AJAX] Installs @WebScheduler on the server.
...

    {
...

        {
            ...
            // Create @WebScheduler database structure.
            ...
            // Insert default @WebScheduler entries into the database.
