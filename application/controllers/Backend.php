...
class Backend extends CI_Controller {
     ...
     * be able to make change to the current @WebScheduler installation (core settings like company name, book
     * timeout etc).
     */
    ...
    protected function _has_privileges($page, $redirect = TRUE)
    {
        ...
        $role_priv = $this->db->get_where('wb_roles', ['slug' => $role_slug])->row_array();
