 ...
 *
 * This function will check some factors to determine if @WebScheduler is
 ...
 *
 * @return bool Returns whether @WebScheduler is installed or not.
 */
function is_ea_installed()
{
    $ci =& get_instance();
    return $ci->db->table_exists('wb_users');
}
