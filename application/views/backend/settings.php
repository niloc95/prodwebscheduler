...
<div id="settings-page" class="container-fluid">
    ...
    <div class="tab-content">
            ...
            <form>
                <div class="row">
                    <fieldset class="col-xs-12 col-sm-6 personal-info-wrapper">
                        ...
                        <!-- <div class="form-group">
                            <label for="medical-aid"><?= lang('medical_aid') ?> *</label>
                            <input id="medical-aid" class="form-control required">
                        </div> -->
        ...
        <div role="tabpanel" class="tab-pane" id="about-app">
            <h3 class="install_sub_headings">@WebScheduler</h3>

            <p class="installpara">
                <?= lang('about_app_info') ?>
            </p>

            <div class="current-version well, install_field_input_heading">
            ...
            <h3 class="install_sub_headings"><?= lang('support') ?></h3>
            <p class="installpara">
                <?= lang('about_app_support') ?>

                <br>

                <a href="http://webScheduler.co.za">
                    <?= lang('official_website') ?>
                </a>
            </p>

            <h3 class="install_sub_headings"><?= lang('license') ?></h3>

            <p class="installpara">
                <?= lang('about_app_license') ?>
                <a href="http://www.semeonline.co.za">SemeOnline Digital</a>
            </p>
        </div>
