            ...
            $('#login-form').submit(function(event) {
                ...
                $.post(postUrl, postData, function(response) {
                    ...
                    if (response == GlobalVariables.AJAX_SUCCESS) {
                        ...
                        $('.alert').text(WBLang['login_failed']);
                        $('.alert')
...
<body>
    ...
    <div id="login-frame" class="frame-container">
        <h2 class="installheading"><?= lang('backend_section') ?></h2>
        <p class="install_sub_headings"><?= lang('you_need_to_login') ?></p>
        <hr>
        <div class="alert hidden"></div>
        <form id="login-form">
            <div class="form-group, install_field_input_heading">
            ...
            <a href="<?= site_url('user/forgot_password') ?>" class="forgot-password, install_field_input_heading">
