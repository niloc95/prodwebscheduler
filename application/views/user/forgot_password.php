            ...
            $('form').submit(function(event) {
                ...
                $.post(postUrl, postData, function(response) {
                    ...
                    if (response == GlobalVariables.AJAX_SUCCESS) {
                        ...
                        $('.alert').text(WBLang['new_password_sent_with_email']);
                    } else {
...
<body>
    <div id="forgot-password-frame" class="frame-container">
        <h2 class="installheading"><?= lang('forgot_your_password') ?></h2>
        <p class="installpara"><?=lang('type_username_and_email_for_new_password') ?></p>
        <hr>
