 ...
 * and the @WebScheduler system. Do not place any model handling inside this
 * library.
 *
 * @package Libraries
 */
class Google_Sync {
     ...
     * when the provider granted consent to @WebScheduler for use his
     ...
     * Sync utility of @WebScheduler and the stored access token is still valid.
     ...
     * provided appointment record of @WebScheduler.
     *
     * @param array $appointment Contains the appointment record data.
     * @param array $provider Contains the provider record data.
     * @param array $service Contains the service record data.
