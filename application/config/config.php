...
/*
|--------------------------------------------------------------------------
| @WebScheduler - Internal Configuration
|--------------------------------------------------------------------------
|
| Declare some of the global config values of @WebScheduler.
|
*/
$config['version'] = '1.8'; // This must be changed manually.
$config['release_label'] = 'February 2020'; // Leave empty for no title or add Alpha, Beta etc ...
...
$config['sess_cookie_name'] = 'wb_session'; //Changed from ea to wb
