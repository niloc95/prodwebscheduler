...
namespace WB\Engine\Notifications;

use \WB\Engine\Types\Text;
use \WB\Engine\Types\NonEmptyText;
use \WB\Engine\Types\Url;
use \WB\Engine\Types\Email as EmailAddress;
...
class Email {
     ...
     * @param \WB\Engine\Types\Text $title The email title may vary depending the receiver.
     * @param \WB\Engine\Types\Text $message The email message may vary depending the receiver.
     * @param \WB\Engine\Types\Url $appointmentLink This link is going to enable the receiver to make changes
     * to the appointment record.
     * @param \WB\Engine\Types\Email $recipientEmail The recipient email address.
     * @param \WB\Engine\Types\Text $icsStream Stream contents of the ICS file.
     */
     ...
     * @param \WB\Engine\Types\Email $recipientEmail The email address of the email recipient.
     * @param \WB\Engine\Types\Text $reason The reason why the appointment is deleted.
     */
     ...
     *
     * @param \WB\Engine\Types\NonEmptyText $password Contains the new password.
     * @param \WB\Engine\Types\Email $recipientEmail The receiver's email address.
