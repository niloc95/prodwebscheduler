 ...
 *
 * Example:
 *   $parser = new \WB\Engine\Api\V1\Parsers\Appointments;
 *   $response = new \WB\Engine\Api\V1\Response($data);
...
class Response {
     ...
     *
     * @return \WB\Engine\Api\V1\Response
     */
     ...
     *
     * @param \WB\Engine\Types\NonEmptyText $status Optional (null), if provided it must contain the status
