...
(function () {
    ...
    CustomersHelper.prototype.bindEventHandlers = function () {
        ...
        $('#delete-customer').click(function () {
            ...
            GeneralFunctions.displayMessageBox(WBLang.delete_customer,
    ...
    CustomersHelper.prototype.save = function (customer) {
        ...
        $.post(postUrl, postData, function (response) {
            ...
            Backend.displayNotification(WBLang.customer_saved);
            this.resetForm();
            $('#filter-customers .key').val('');
    ...
    CustomersHelper.prototype.delete = function (id) {
        ...
        $.post(postUrl, postData, function (response) {
            ...
            Backend.displayNotification(WBLang.customer_deleted);
            this.resetForm();
    ...
    CustomersHelper.prototype.display = function (customer) {
        ...
        $('#medical-aid').val(customer.medical_aid);
    ...
    CustomersHelper.prototype.filter = function (key, selectId, display) {
        ...
        $.post(postUrl, postData, function (response) {
            ...
            if (response.length == 0) {
                $('#filter-customers .results').html('<em>' + WBLang.no_records_found + '</em>');
            }
