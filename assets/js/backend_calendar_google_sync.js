    ...
    function _bindEventHandlers() {
        ...
        $('#enable-sync').click(function () {
            if ($('#enable-sync').hasClass('enabled') === false) {
                ...
                var windowHandle = window.open(authUrl, 'Authorize @WebScheduler',
        ...
        $('#select-calendar').click(function () {
            ...
            $.post(postUrl, postData, function (response) {
                ...
                Backend.displayNotification(WBLang.google_calendar_selected);
        ...
        $('#google-sync').click(function () {
            ...
            $.ajax({
                ...
                .done(function (response) {
                    ...
                    Backend.displayNotification(WBLang.google_sync_completed);
                    $('#reload-appointments').trigger('click');
                })
                .fail(function (jqXHR, textStatus, errorThrown) {
                    Backend.displayNotification(WBLang.google_sync_failed);
                });
        });
    }
