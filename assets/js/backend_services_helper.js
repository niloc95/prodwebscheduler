...
(function () {
    ...
    ServicesHelper.prototype.bindEventHandlers = function () {
        ...
        $('#delete-service').click(function () {
            ...
            GeneralFunctions.displayMessageBox(WBLang.delete_service,
    ...
    ServicesHelper.prototype.save = function (service) {
        ...
        $.post(postUrl, postData, function (response) {
            ...
            Backend.displayNotification(WBLang.service_saved);
            this.resetForm();
            $('#filter-services .key').val('');
    ...
    ServicesHelper.prototype.delete = function (id) {
        ...
        $.post(postUrl, postData, function (response) {
            ...
            Backend.displayNotification(WBLang.service_deleted);
    ...
    ServicesHelper.prototype.filter = function (key, selectId, display) {
        ...
        $.post(postUrl, postData, function (response) {
            ...
            if (response.length === 0) {
                $('#filter-services .results').html('<em>' + WBLang.no_records_found + '</em>');
            }
