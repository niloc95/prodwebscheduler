...
(function () {
    ...
    CategoriesHelper.prototype.bindEventHandlers = function () {
        ...
        $('#delete-category').click(function () {
            ...
            GeneralFunctions.displayMessageBox(WBLang.delete_category,
    ...
    CategoriesHelper.prototype.filter = function (key, selectId, display) {
        ...
        $.post(postUrl, postData, function (response) {
            ...
            if (response.length === 0) {
                $('#filter-categories .results').html('<em>' + WBLang.no_records_found + '</em>');
            }
    ...
    CategoriesHelper.prototype.save = function (category) {
        ...
        $.post(postUrl, postData, function (response) {
            ...
            Backend.displayNotification(WBLang.service_category_saved);
            this.resetForm();
            $('#filter-categories .key').val('');
    ...
    CategoriesHelper.prototype.delete = function (id) {
        ...
        $.post(postUrl, postData, function (response) {
            ...
            Backend.displayNotification(WBLang.service_category_deleted);
