...
(function () {
            ...
            if (workingDay != null) {
                ...
                $.each(workingDay.breaks, function (i, brk) {
                    ...
                    var tr =
                        ...
                        '<td>' +
                        '<button type="button" class="btn btn-default btn-sm edit-break" title="' + WBLang.edit + '">' +
                        '<span class="glyphicon glyphicon-pencil"></span>' +
                        '</button>' +
                        '<button type="button" class="btn btn-default btn-sm delete-break" title="' + WBLang.delete + '">' +
                        '<span class="glyphicon glyphicon-remove"></span>' +
                        '</button>' +
                        '<button type="button" class="btn btn-default btn-sm save-break hidden" title="' + WBLang.save + '">' +
                        '<span class="glyphicon glyphicon-ok"></span>' +
                        '</button>' +
                        '<button type="button" class="btn btn-default btn-sm cancel-break hidden" title="' + WBLang.cancel + '">' +
    ...
    WorkingPlan.prototype.editableBreakDay = function ($selector) {
        var weekDays = {};
        weekDays[WBLang.sunday] = WBLang.sunday; //'Sunday';
        weekDays[WBLang.monday] = WBLang.monday; //'Monday';
        weekDays[WBLang.tuesday] = WBLang.tuesday; //'Tuesday';
        weekDays[WBLang.wednesday] = WBLang.wednesday; //'Wednesday';
        weekDays[WBLang.thursday] = WBLang.thursday; //'Thursday';
        weekDays[WBLang.friday] = WBLang.friday; //'Friday';
        weekDays[WBLang.saturday] = WBLang.saturday; //'Saturday';
    ...
    WorkingPlan.prototype.bindEventHandlers = function () {
        ...
        $('.add-break').click(function () {
            var tr =
                '<tr>' +
                '<td class="break-day editable">' + WBLang.sunday + '</td>' +
    ...
    WorkingPlan.prototype.convertValueToDay = function (value) {
        switch (value) {
            case 'sunday':
                return WBLang.sunday;
            case 'monday':
                return WBLang.monday;
            case 'tuesday':
                return WBLang.tuesday;
            case 'wednesday':
                return WBLang.wednesday;
            case 'thursday':
                return WBLang.thursday;
            case 'friday':
                return WBLang.friday;
            case 'saturday':
                return WBLang.saturday;
        }
    };
    ...
    WorkingPlan.prototype.convertDayToValue = function (day) {
        switch (day) {
            ...
            case WBLang.tuesday:
                return 'tuesday';
            case WBLang.wednesday:
                return 'wednesday';
            case WBLang.thursday:
                return 'thursday';
            case WBLang.friday:
                return 'friday';
            case WBLang.saturday:
                return 'saturday';
        }
    };
